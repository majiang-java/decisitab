...
public class TreeGrid implements java.io.Serializable {
	...
	public String toJson() {
		return "{" + "'id':'" + id + '\'' + ", 'text':'" + text + '\'' + ", 'parentId':'" + parentId + '\''
				+ ", 'parentText':'" + parentText + '\'' + ", 'code':'" + code + '\'' + ", 'src':'" + src + '\''
				+ ", 'note':'" + note + '\'' + ", 'attributes':" + attributes + ", 'operations':'" + operations + '\''
				+ ", 'state':'" + state + '\'' + ", 'order':'" + order + '\'' + assembleFieldsJson() + '}';
	}
	...
	private String assembleFieldsJson() {
		...
		if (fieldMap != null && fieldMap.size() > 0) {
			...
			for (Map.Entry<String, Object> entry : fieldMap.entrySet()) {
				...
				resultMap.put("fieldMap." + entry.getKey(), valueStr);
			}
