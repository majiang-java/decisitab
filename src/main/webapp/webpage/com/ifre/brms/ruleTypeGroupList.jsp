...
<div id="main_typegroup_list" class="easyui-layout" fit="true">
    <div region="center" style="padding:0px;border:0px">
        <t:datagrid name="typeGridTree" title="规则变量" actionUrl="modelVarController.do?typeGroupGrid&prodType=2" queryMode="group" idField="id" treegrid="false" pageSize="20" sortOrder="desc" sortName="id" onLoadSuccess="loadSuccess">
            ...
            <t:dgToolBar title="common.add.param" langArg="变量" icon="icon-add" url="modelVarController.do?aouTypeGroup&prodType=2" funname="add"></t:dgToolBar>
...
<script type="text/javascript">
    ...
    function queryTypeValue(typegroupid, varTypegroupname){
        title = '规则变量: ' + varTypegroupname;
        if(li_east == 0){
            $('#main_typegroup_list').layout('expand','east');
        }
        $('#main_typegroup_list').layout('panel','east').panel('setTitle', title);
        $('#userListpanel').panel("refresh", "modelVarController.do?goTypeGrid&prodType=2&typegroupid=" + typegroupid);
    }
