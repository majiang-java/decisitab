...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="ruleProdList" title="决策方案" actionUrl="ruleTesterController.do?datagrid&prodType=1" idField="id" fit="true" queryMode="group" sortOrder="desc" pageSize="20">
