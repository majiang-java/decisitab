...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="ruleProdList" title="决策方案" actionUrl="ruleProdController.do?datagrid" idField="id" fit="true" queryMode="group" sortOrder="desc" pageSize="20">
   ...
   <t:dgCol title="产品" field="kknwldgId"  dictionary="kKnwldgId"  width="120" query="true"></t:dgCol>
   ...
   <t:dgCol title="状态" field="status" dictionary="prodStatus" width="120"></t:dgCol>
