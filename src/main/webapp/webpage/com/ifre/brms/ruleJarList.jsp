...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="ruleProdList" title="决策打包" actionUrl="ruleTesterController.do?datagridJarList&prodType=2" idField="id" fit="true" queryMode="group" sortOrder="desc" pageSize="20">
