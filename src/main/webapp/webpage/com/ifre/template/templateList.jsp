...
<t:datagrid name="addTemplateList" title="模版管理" actionUrl="templateMangerController.do?ruleTreeGrid" idField="id" treegrid="true" pagination="false">
	...
	<t:dgDelOpt url="templateMangerController.do?del&id={id}" title="删除"></t:dgDelOpt>
	<t:dgToolBar title="上传" icon="icon-edit" url="fileController.do?uploadTemplateview" funname="add" operationCode="upload"></t:dgToolBar>
