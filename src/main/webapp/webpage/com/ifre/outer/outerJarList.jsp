...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="ruleProdList" title="决策打包" actionUrl="ruleTesterController.do?datagridJarList&prodType=${prodType }" idField="id" fit="true" queryMode="group" sortOrder="desc" pageSize="20">
   ...
   <t:dgDelOpt url="ruleProdController.do?downJarOuter&fileName={name}&version={versionId}&packStatus={packStatus}" title="决策包下载"></t:dgDelOpt>
   <t:dgFunOpt funname="callJar(id,name)" title="调用jar包" operationCode="callJar"></t:dgFunOpt>
 ...
 $(function() {
 	...
 	function pckBizObject(id){
	        var url = "ruleProdController.do?makePckOuter&id="+id;
	        //add('打包产品', url, null); 
	...
	function callJar(id,name){
		  var url = "ruleTesterController.do?outerCallJar&id="+id;
